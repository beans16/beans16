...
<!-- <img src="../assets/img/BCPlogo.png" style="width: 100%;object-fit: contain;height: 100%" alt="IMG"> -->
      ...
      <div class="wrap-login100">
        <form class="login100-form validate-form" action="" method="POST">
          ...
          <div class="text-center p-t-46 p-b-20">
            <span class="txt2">
              or <a href="../SIS_LandingPage/index.php"><i class="fa fa-arrow-left"></i> Back to Home</a>
            </span> 
          </div>
        ...
        <div class="login100-more" style="background: #0037a4f5;">
          <img src="../assets/img/mvcampus.jpg" style="object-fit: contain">
        </div>
      </div>
    </div>
  </div>
